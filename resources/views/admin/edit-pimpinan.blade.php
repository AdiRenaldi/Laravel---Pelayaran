...
<div class="ms-3 mt-3">
    <h4 class="">Tambah User Pimpinan</h4>
    <div class="border-0 scrol">
      <div class=" tbl-scrol">

        <form action="/prosesEditPimpinan/{{ $pimpinan->id }}" method="POST">
        @csrf
          <div class="mb-3 row">
            <label for="nama" class="col-md-2 col-form-label-sm">Nama</label>
            <div class="col-md-10">
              <input type="text" name="nama" class="form-control w-50 @error('nama') is-invalid @enderror" id="nama" value="{{ old('nama',$pimpinan->nama) }}">
                @error('nama')
          ...
          <div class="mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" name="username" class="form-control w-50 @error('username') is-invalid @enderror" id="username" value="{{ old('username',$pimpinan->username) }}">
                @error('username')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
